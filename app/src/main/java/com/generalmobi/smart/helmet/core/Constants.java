...
package com.generalmobi.smart.helmet.core;
...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.generalmobi.gvts";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "GVTS";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.generalmobi.gvts.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.generalmobi.gvts.";
