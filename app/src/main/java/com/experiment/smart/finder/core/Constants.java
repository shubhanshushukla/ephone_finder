...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.experiment.gvts";
         ...
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.experiment.gvts.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.experiment.gvts.";
